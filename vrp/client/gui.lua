...
-- REJECT
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterCommand("Reject",function(source,args)
...
-- KEYMAPPING
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterKeyMapping("Cancel","Cancelar animações","keyboard","F6")
RegisterKeyMapping("Handsup","Levantar as mãos","keyboard","X")
RegisterKeyMapping("Point","Apontar os dedos","keyboard","B")
RegisterKeyMapping("Engine","Agachar / Ligar veículo","keyboard","Z")
...
RegisterKeyMapping("Accept","Aceitar chamado","keyboard","Y")
RegisterKeyMapping("Reject","Rejeitar chamado","keyboard","U")
RegisterKeyMapping("Lock","Trancar veículo","keyboard","L")